                ...
                <div class="form-body">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="control-label">4th Signatory <span class="required"> * </span></label>
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" value="<?=isset($arrData[0]['Signatory4'])?$arrData[0]['Signatory4']:''?>" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
