<script>
    $(document).ready(function() {
        $('#table-ob').on('click','a#printreport',function(){
            ...
            var link = "<?=base_url('employee/reports/generate/?rpt=reportOB')?>"+"&obtype="+obtype+"&reqdate="+reqdate+"&obdatefrom="+obdatefrom+"&obdateto="+obdateto+"&obtimefrom="+obtimefrom+"&obtimeto="+obtimeto+"&desti="+desti+"&meal="+meal+"&purpose="+purpose+"&empnum="+empnum+"&sfunds="+sfunds;
        ...
        $('#table-to').on('click','a#printreport',function(){
            ...
            var link = "";
            link = "<?=base_url('employee/reports/generate/?rpt=reportTO')?>"+"&endate="+date_id+"&rid="+req_id+"&desti="+desti+"&todatefrom="+todatefrom+"&todateto="+todateto+"&purpose="+purpose+"&meal="+meal+"&empno="+empno+"&sfunds="+sfunds;
        ...
        /*
            Click event updated by Loreto G. Gabawa Jr.
            10/26/2021
